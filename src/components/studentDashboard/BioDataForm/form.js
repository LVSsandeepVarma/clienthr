  ...
  const [initialValues, setInitialValues] = useState(
    {
      ...
      birthPlace: `${userInfo?.biodata?.place_birth ? userInfo?.biodata?.place_birth : ""}`,
      phoneCode: "",
      phoneNumber:  "",
      homePhoneCode: "",
      homePhoneNumber: `${userInfo?.biodata?.home_phone ? userInfo?.biodata?.home_phone : ""}`,
      bloodGroup: `${userInfo?.biodata?.blood_group ? userInfo?.biodata?.blood_group : ""}`,
      skills: userInfo?.biodata?.skills ? [userInfo?.biodata?.skills] : [],
      mothersName: `${userInfo?.biodata?.mother_name ? userInfo?.biodata?.mother_name : ""}`,
      fathersName: `${userInfo?.biodata?.father_name ? userInfo?.biodata?.father_name : ""}`,
      citizenshipId: `${userInfo?.biodata?.citizenship_id ? userInfo?.biodata?.citizenship_id : ""}`,
      taxId: `${userInfo?.biodata?.tax_id ? userInfo?.biodata?.tax_id : ""}`,
      passportId: `${userInfo?.biodata?.passport_id ? userInfo?.biodata?.passport_id : ""}`,
      passportIssuedDate: `${userInfo?.biodata?.passport_issued ? userInfo?.biodata?.passport_issued : ""}`,
      passportExpiryDate: `${userInfo?.biodata?.passport_expiry ? userInfo?.biodata?.passport_expiry : ""}`,
      languagesSpeak: userInfo?.biodata?.languages_speak ? [userInfo?.biodata?.languages_speak] : [],
      languages: userInfo?.biodata?.languages_write ? [userInfo?.biodata?.languages_write] : [],
    })
      ...
      {({values, resetForm})=>(
              ...
              <div className="  ">
                ...
                <div className="">
                  ...
                  <p className="!text-red-800 font-bold" style={{ color: "red" }}>
                    <ErrorMessage className="!text-red-600 font-bold" name="skills" />
                  </p>
                </div>
